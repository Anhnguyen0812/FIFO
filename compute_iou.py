...
def compute_mIoU(gt_dir, pred_dir, devkit_dir, dataset):
    ...
    if not 'FZ' in dataset:
        mapping = np.array(label2train, dtype=int)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--devkit_dir', default='/home/anhngp/data1/Foggy_Zurich/lists_file_names', help='base directory of zurich')
