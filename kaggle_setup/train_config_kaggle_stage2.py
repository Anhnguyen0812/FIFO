...
# ============================================================================
# KAGGLE PATHS - Based on actual dataset structure
# ============================================================================
KAGGLE_DATA_ROOT = '/kaggle/input/cityscapes-filtered-fog'

# Foggy images: /kaggle/input/cityscapes-filtered-fog/foggy_filtered/foggy_data/leftImg8bit_foggy/train/
DATA_DIRECTORY = f'{KAGGLE_DATA_ROOT}/foggy_filtered/foggy_data/leftImg8bit_foggy'
DATA_LIST_PATH = f'./dataset/cityscapes_list/train_foggy_{BETA}.txt'

# Clear images: /kaggle/input/cityscapes-filtered-fog/leftImg8bit_filtered/leftImg8bit_data/leftImg8bit/train/
DATA_DIRECTORY_CWSF = f'{KAGGLE_DATA_ROOT}/leftImg8bit_filtered/leftImg8bit_data/leftImg8bit'
DATA_LIST_PATH_CWSF = './dataset/cityscapes_list/train_origin.txt'

# Real fog: /kaggle/input/cityscapes-filtered-fog/realfog_filtered_2gb/RGB/
DATA_DIR = f'{KAGGLE_DATA_ROOT}/realfog_filtered_2gb'
