"""
Script chính để train FIFO trên Kaggle
Copy từ main.py và điều chỉnh cho Kaggle environment
"""
import os
...
# Import dataset classes cho Kaggle
# Cần copy các file dataset vào thư mục kaggle_setup
from kaggle_setup.paired_cityscapes_kaggle import Pairedcityscapes_Kaggle
from kaggle_setup.foggy_zurich_kaggle import FoggyZurich_Kaggle
...
def main():
    ...
    # Setup Wandb - sử dụng offline mode nếu cần
    wandb.init(project='FIFO-Kaggle', name=f'{run_name}')
    ...
    # Load datasets với Kaggle paths
    print("Loading datasets...")
    cwsf_pair_loader = data.DataLoader(
        Pairedcityscapes_Kaggle(
