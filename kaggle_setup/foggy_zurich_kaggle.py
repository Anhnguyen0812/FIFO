...
class FoggyZurich_Kaggle(data.Dataset):
    """
    ...
    def __init__(self, root, list_path, max_iters=None, mean=(128, 128, 128), ignore_label=255, set='train'):
        """
        Args:
            root: Root path (/kaggle/input/cityscapes-filtered-fog)
            list_path: File list của real fog images
        """
        self.root = root
